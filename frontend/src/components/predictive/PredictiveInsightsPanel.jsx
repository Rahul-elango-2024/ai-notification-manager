  ...
  return (
    <div className="panel predictive-insights-panel" role="region" aria-label="Gemini AI Diagnostic Insights">
      <div className="panel-header">
        <div>
          <h2>🤖 Gemini AI Diagnostic Insights</h2>
          <p>Real-time predictive telemetry generated by Gemini AI analyzing log anomalies, metric spikes, and historical trends.</p>
        </div>
        <span className="ai-live-badge">⚡ Real-time Telemetry Stream</span>
      </div>
      ...
      <div className="insights-grid-container">
        {activeInsights.map((item) => (
          <div key={item.id || item.kpi_id} className={`insight-card severity-${(item.severity || "HIGH").toLowerCase()}`}>
            ...
            <p className="insight-body-text">{item.insight || item.ai_recommendation || "AI analysis indicates potential system anomaly."}</p>
